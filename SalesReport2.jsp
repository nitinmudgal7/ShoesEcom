...
<body >
	...
	<!-- Nitin -->
	<form action = "SalesReport2.jsp" method = "GET">
	...
	<div class="row">
		...
		<div class="container">
			<hr>
			<% String hidden = request.getParameter("Date"); %>

<!-- Report 1 -->
<h2>Sales For SportyShoes.com by Date</h2>    
   <sql:query var="rs" dataSource="${database}">
         SELECT * FROM sales where date = "<%=hidden %>";
    </sql:query>    
<style>
table {
